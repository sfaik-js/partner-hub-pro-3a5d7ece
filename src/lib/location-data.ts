...
export const LOCATION_DATA: LocationData = {
  "Afrique": {
    ...
    "Sénégal": {
      "Dakar": { "Dakar": ["Dakar", "Pikine", "Rufisque"] },
      "Thiès": { "Thiès": ["Thiès", "Mbour", "Tivaouane"] },
      "Saint-Louis": { "Saint-Louis": ["Saint-Louis", "Dagana", "Podor"] },
    },
    "Côte d'Ivoire": {
      "Abidjan": { "Abidjan": ["Abidjan", "Bingerville", "Anyama"] },
      "Yamoussoukro": { "Yamoussoukro": ["Yamoussoukro", "Attiégouakro"] },
      "Bouaké": { "Bouaké": ["Bouaké", "Sakassou"] },
    },
  },
  "Europe": {
    "France": {
      "Île-de-France": { "Paris": ["Paris", "Boulogne-Billancourt", "Versailles", "Nanterre"] },
    ...
    "Belgique": {
      "Bruxelles": { "Bruxelles": ["Bruxelles", "Anderlecht", "Schaerbeek"] },
      "Flandre": {
        "Anvers": ["Anvers"],
    ...
    "Suisse": {
      "Genève": { "Genève": ["Genève", "Vernier", "Lancy"] },
      "Vaud": { "Vaud": ["Lausanne", "Yverdon-les-Bains", "Montreux"] },
      "Zurich": { "Zurich": ["Zurich", "Winterthour", "Uster"] },
    },
  },
  "Amérique": {
    "Canada": {
      "Québec": { "Québec": ["Montréal", "Québec", "Laval", "Gatineau"] },
      "Ontario": { "Ontario": ["Toronto", "Ottawa", "Mississauga"] },
      "Colombie-Britannique": { "Colombie-Britannique": ["Vancouver", "Victoria", "Surrey"] },
    },
    "États-Unis": {
      "Californie": { "Californie": ["Los Angeles", "San Francisco", "San Diego"] },
      "New York": { "New York": ["New York City", "Buffalo", "Albany"] },
      "Texas": { "Texas": ["Houston", "Austin", "Dallas"] },
    },
  },
  "Asie": {
    "Japon": {
      "Kantō": { "Tokyo": ["Tokyo", "Yokohama", "Chiba"] },
      "Kansai": { "Osaka": ["Osaka", "Kyoto", "Kobe"] },
    },
    "Émirats Arabes Unis": {
      "Abou Dabi": { "Abou Dabi": ["Abou Dabi", "Al-Aïn"] },
      "Dubaï": { "Dubaï": ["Dubaï"] },
    },
  },
};
